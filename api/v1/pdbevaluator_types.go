...
const (
	PDBEvaluatorMetadataName = "pdb-evaluator"
)
...
type PDBEvaluatorSpec struct {
	...
	Rules rules.PDBRules `json:"rules,omitempty"`
}
...
//  PDBEvaluator is the Schema for the pdbevaluators API
type PDBEvaluator struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   PDBEvaluatorSpec   `json:"spec,omitempty"`
