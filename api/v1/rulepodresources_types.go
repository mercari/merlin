...
type RulePodResourcesSpec struct {
	...
	// Foo is an example field of RulePodResources. Edit RulePodResources_types.go to remove/update
...
type RulePodResources struct {
	...
	Status RulePodResourcesStatus `json:"status,omitempty"`
}
...
func init() {
	SchemeBuilder.Register(&RulePodResources{}, &RulePodResourcesList{})
}
